...
$view->setVariable("title", "Mis campeonatos");
        ...
        <table>
          <tbody>
            <tr class="row100 body">
              ...
              <td class="cell100 column4"><a href="<?="index.php?controller=campeonatos&action=verEnfrentamientosCampeonato&idCampeonato=".$campeonato->getIdCampeonato() ?>">
              <i class="fas fa-table-tennis"></i>
              </a></td>

              <td class="cell100 column4"><a href="<?="index.php?controller=campeonatos&action=showRanking&idCampeonato=".$campeonato->getIdCampeonato()?>">
